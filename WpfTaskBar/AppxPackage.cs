...
public class AppxPackageUtility
{
    ...
    public sealed class AppxPackage
    {
        ...
        {
            get { return QueryPackageInfo(FullName, PackageConstants.PACKAGE_FILTER_ALL_LOADED).Where(p => p.FullName != FullName); }
        }
        ...
        public static AppxPackage FromProcess(IntPtr hwnd, int processId)
        {
            ...
            try
            {
                ...
                GetWindowThreadProcessId(uwpHandle, out processId);
